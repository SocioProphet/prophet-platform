...
- the demo remains non-secret and does not expose raw prompts, credentials, or private local state.
...
- Do not store secrets, credentials, raw private prompts, or private local state.
