...
KNOWN_BROKEN = {
    ...
    "owl-reasoner:moving-tag": (
        "New service — Dockerfile + images.yml entry added this PR, so it BUILDS. Pin tag:latest -> sha- "
        "after the first CI build (same chicken-and-egg as grlplus-service/grl-mesh)."
    ),
