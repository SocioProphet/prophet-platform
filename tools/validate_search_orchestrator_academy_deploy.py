...
REQUIRED = [
    ...
    "docs/SEARCH_ORCHESTRATOR_ACADEMY_BRIDGE_ROLLOUT_EVIDENCE.md",
    "docs/SEARCH_ORCHESTRATOR_ACADEMY_BRIDGE_MULTICLOUD_ROLLOUT_PREP.md",
    "releases/evidence/search-orchestrator-academy-rollout-evidence.template.json",
    "releases/evidence/search-orchestrator-academy-multicloud-rollout-matrix.v0.1.json",
...
REQUIRED_TEXT = {
    ...
    "releases/images/search-orchestrator.image-lock.json": [
        "search-orchestrator-image-lock",
        "sha256:bbfea6e4a7ea432d77766a37464dfa666242dfe2621fc0e586ca2bde80c52066",
        "status",
    ],
    "tools/render_search_orchestrator_image_patch.py": [
    ...
    "infra/k8s/search-orchestrator/overlays/policy/image-patch.yaml": [
        "ghcr.io/socioprophet/prophet-platform/search-orchestrator@sha256:bbfea6e4a7ea432d77766a37464dfa666242dfe2621fc0e586ca2bde80c52066",
    ],
    "infra/argocd/appsets/search-orchestrator-academy-appset.yaml": [
    ...
    "releases/evidence/search-orchestrator-academy-rollout-evidence.template.json": [
        "template-pending-real-cluster-capture",
        "rendered_manifests",
    ...
    "releases/evidence/search-orchestrator-academy-multicloud-rollout-matrix.v0.1.json": [
        ...
        "restricted-v2-compatible",
    ],
    "tools/validate_search_orchestrator_multicloud_rollout.py": [
        "search-orchestrator multicloud rollout preparation validated",
        "REQUIRED_GLOBAL",
        "REQUIRED_OPENSHIFT",
    ],
    "releases/evidence/search-orchestrator.academy-bridge.validation.record.json": [
