...
def build_agent_core_plan(
    ...
    return {
        ...
        "agent_plane": {
            ...
            "approval_gates": [
                {
                    "id": "deploy-plan-approval",
                    "action": "approve FogStack deploy plan before runtime deployment",
                    "required_approvals": 1,
                    "human_required": True,
                },
                {
                    "id": "dangerous-action-quorum",
                    "action": "approve network, secrets, production, or destructive runtime action",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build a FogStack agent core plan")
    parser.add_argument("--bundle-id", default="fogstack.access")
    parser.add_argument("--version", default="0.1.0")
    parser.add_argument("--agent-id", default="agent:fogstack.access.operator")
