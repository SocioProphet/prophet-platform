    ...
    # ── 1. RAG ─────────────────────────────────────────────────────────────────────────────────
    {
        ...
        "features": [
            ...
            {"feature_id": "embedding_governance", "name": "Embedding-space governance",
             ...
             "default": _c("BEAT", "live",
                           [{"repo": "Noetica", "pr": "82", "note": "embedding-space pin"},
                            {"repo": "Noetica", "pr": "602", "note": "unblock nextjs — embed RAG queries in the pinned 768 corpus space"},
                            {"repo": "Noetica", "pr": "605",
            ...
            {"feature_id": "contextual_retrieval_fusion", "name": "Contextual retrieval + RAG-Fusion",
             ...
             "default": _c("BEAT", "spec",
                           [{"repo": "Noetica", "pr": "607", "note": "contextual-retrieval: merged + tested, NOT wired into live ingest/query"},
                            {"repo": "Noetica", "pr": "604", "note": "query-variant RAG-Fusion: merged + tested, not live-wired"}],
    ...
    # ── 2. Agent framework ──────────────────────────────────────────────────────────────────────
    {
        ...
        "features": [
            ...
            {"feature_id": "agent_identity_passport", "name": "Agent identity / passport",
             ...
             "default": _c("BEAT", "live",
                           [{"repo": "sourceos-spec", "path": "schemas/AgentPassport.json", "note": "5-class, T0-1, OS-process level"},
            ...
            {"feature_id": "os_workspace_native", "name": "OS / workspace-native",
             ...
             "default": _c("BEAT", "live",
                           [{"repo": "SourceOS", "note": "OS layer"},
                            {"repo": "sourceos-spec", "path": "schemas/AgentPassport.json", "note": "OS-process->authority binding"}],
