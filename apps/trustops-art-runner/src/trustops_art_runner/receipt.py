    ...
    *,
    ...
    receipt: dict[str, Any] = {
        ...
        "evaluation": {
            ...
            "metrics": [
                {"name": "evasion_attack_success_rate", "value": 0.08, "threshold": 0.10, "direction": "at-or-below", "status": "pass", "sliceRef": "all"},
                {"name": "membership_inference_risk", "value": "low", "threshold": "medium", "direction": "at-or-below", "status": "pass", "sliceRef": "all"},
                {"name": "model_extraction_probe", "value": "not-detected", "threshold": "not-detected", "direction": "equals", "status": "pass", "sliceRef": "all"},
            ],
        },
        "policy": {"gateRef": "trustgate.platform-default.robustness", "decision": "allow", "reviewer": "automation"},
        "result": {
            "status": "pass",
        ...
        "actions": [
            {"target": "model-governance-ledger", "action": "record", "details": "Store robustness receipt and promotion evidence."},
            {"target": "guardrail-fabric", "action": "allow", "details": "Synthetic smoke profile produced no blocking robustness signal."},
        ],
        "provenance": {
            "createdAt": timestamp,
