...
export const ATLAS: Record<string, AtlasPlate> = {
  nervous: {
    ...
    vendored: 'atlas/systems/nervous.png',
    remote: commons('1201 Overview of Nervous System.jpg'),
    source: 'OpenStax A&P 2e — fig. 12.1 “Overview of the Nervous System”',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:1201_Overview_of_Nervous_System.jpg',
    license: 'CC BY 4.0', attribution: 'OpenStax Anatomy & Physiology 2e (fig. 12.1), CC BY 4.0',
  },
  cardiovascular: {
    title: 'Cardiovascular system',
    vendored: 'atlas/systems/cardiovascular.png',
    remote: commons('2005 Surface Anatomy of the Heart.jpg'),
    source: 'OpenStax A&P 2e — fig. 19.5 “Surface Anatomy of the Heart”',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:2005_Surface_Anatomy_of_the_Heart.jpg',
    license: 'CC BY 4.0', attribution: 'OpenStax Anatomy & Physiology 2e (fig. 19.5), CC BY 4.0',
  },
  respiratory: {
  ...
  hepatic: {
    ...
    vendored: 'atlas/systems/digestive.png',
    remote: commons('2401 Components of the Digestive System.jpg'),
    source: 'OpenStax A&P 2e — fig. 23.1 “Components of the Digestive System”',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:2401_Components_of_the_Digestive_System.jpg',
    license: 'CC BY 4.0', attribution: 'OpenStax Anatomy & Physiology 2e (fig. 23.1), CC BY 4.0',
  },
  urinary: {
    title: 'Urinary system',
    vendored: 'atlas/systems/urinary.png',
    remote: commons('2610 The Kidney.jpg'),
    source: 'OpenStax A&P 2e — fig. 25.3 “The Kidney”',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:2610_The_Kidney.jpg',
    license: 'CC BY 4.0', attribution: 'OpenStax Anatomy & Physiology 2e (fig. 25.3), CC BY 4.0',
  },
};
