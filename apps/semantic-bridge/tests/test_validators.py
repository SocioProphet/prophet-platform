...
def test_validate_zone_publication_request_reports_missing_keys() -> None:
    result = validate_zone_publication_request({"carrier_ref": "carrier://sha256/example"})
    assert result["ok"] is False
    assert "zone_ref" in result["missing"]
