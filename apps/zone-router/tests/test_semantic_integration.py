...
def test_plan_request_cli_includes_semantic_validation(tmp_path: Path, capsys) -> None:
    ...
    assert payload["semantic_validation"]["request"]["ok"] is True
    assert payload["semantic_validation"]["plan"]["ok"] is True


def test_enqueue_request_cli_includes_record_validation(tmp_path: Path, monkeypatch, capsys) -> None:
