...
ITEMS: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ...
    ("A triangle has this many sides:", " three", (" four", " five", " six")),
    ("A bicycle normally has this many wheels:", " two", (" three", " four", " one")),
    ("Twelve divided by four equals", " three", (" four", " six", " two")),
    ("The first month of the calendar year is", " January", (" March", " December", " June")),
    ("The opposite of 'ascend' is", " descend", (" climb", " rise", " hover")),
    ("A decade spans this many years:", " ten", (" twenty", " five", " one hundred")),
    ("The past tense of 'run' is", " ran", (" runned", " runs", " running")),
    ("Mixing blue and yellow paint produces", " green", (" purple", " orange", " grey")),
    ("The sun rises in the", " east", (" west", " north", " south")),
    ("A week contains this many days:", " seven", (" ten", " five", " twelve")),
    ("The plural of 'mouse' is", " mice", (" mouses", " mices", " mouse")),
    ("Nine minus four equals", " five", (" thirteen", " three", " six")),
    ("The tallest land animal is the", " giraffe", (" elephant", " horse", " camel")),
    ("A square has this many equal sides:", " four", (" three", " six", " eight")),
    ("The letter that follows M in the alphabet is", " N", (" L", " O", " P")),
    ("Half of twenty is", " ten", (" five", " forty", " fifteen")),
    ("The main gas in Earth's atmosphere is", " nitrogen", (" oxygen", " carbon dioxide", " helium")),
    ("A baby cat is called a", " kitten", (" puppy", " cub", " foal")),
    ("Three multiplied by three equals", " nine", (" six", " twelve", " thirty-three")),
    ("The season that follows summer is", " autumn", (" spring", " winter", " monsoon")),
    ("The currency of Japan is the", " yen", (" won", " yuan", " ringgit")),
    ("An hour contains this many minutes:", " sixty", (" thirty", " one hundred", " twenty-four")),
    ("The organ that pumps blood is the", " heart", (" liver", " lung", " kidney")),
    ("The colour of a ripe banana is", " yellow", (" blue", " purple", " black")),
)
