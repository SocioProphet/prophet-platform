...
lattice-studio-smoke:
	...
	PYTHONPATH=apps/lattice-studio/src python3 -m lattice_studio.cli emit-memory --subject workspace://demo --subject atlas-context:demo --subject paas-deployment:demo --subject lampstand://local-search/demo --subject ontogenesis://lattice-studio/demo --subject execution://demo --link catalog://datasets/demo-csv@0.1.0 --output build/lattice-studio/memory-events.json
